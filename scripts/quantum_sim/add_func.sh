...
for dim in 2 3
do
  for fun in alpine01 alpine02 levy deflectedCorrugatedSpring wavy rosenbrock mishra
    do
...
for fun in rosenbrock alpine01 alpine02 levy mishra deflectedCorrugatedSpring wavy
do
  for method in cmaes quads adam
  do
